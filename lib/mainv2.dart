        ...
        htPrimaryWidgets.addAll(<Widget>[
          ...
          MaterialButton(
            ...
            onPressed: () async {
              ...
              for (var element in _htResultNetwork!) { oui = _htResultNetwork!.first!.ssid;}
              if (oui!.contains('Android') == true) {
                // ignore: avoid_print
                print(oui);} else {
                // ignore: avoid_print
                print('tg');
              ...
              //for (var element in _htResultNetwork!) {(oui!.add(element!.ssid));}
              //print(oui);
              setState(() {});
    ...
    if (_isEnabled) {
      ...
      if (_isConnected) {
        ...
        htPrimaryWidgets.addAll(<Widget>[
          ...
          MaterialButton(
            color: Colors.blue,
            child: Text("Connect to 'test'", style: textStyle),
            onPressed: () {
              WiFiForIoTPlugin.connect(STA_DEFAULT_SSID,
                  password: STA_DEFAULT_PASSWORD,
                  joinOnce: true,
